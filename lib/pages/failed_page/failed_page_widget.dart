...
class FailedPageWidget extends StatefulWidget {
  const FailedPageWidget({Key? key}) : super(key: key);

  @override
  _FailedPageWidgetState createState() => _FailedPageWidgetState();
}
...
class _FailedPageWidgetState extends State<FailedPageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: Color(0xFFFF0013),
        body: SafeArea(
          top: true,
          child: Column(
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Lottie.asset(
                      'assets/lottie_animations/56947-icon-failed.json',
                      width: 200.0,
                      height: 200.0,
                      fit: BoxFit.cover,
