  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> profilUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final profilUsersRecord = profilUsersRecordList.isNotEmpty
            ? profilUsersRecordList.first
            : null;
              ...
              children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: AuthUserStreamWidget(
                        builder: (context) => Text(
                          formatNumber(
                            valueOrDefault(currentUserDocument?.spent, 0.0),
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      await launchURL(
                          'https://docs.deliveree.delivery/terms-of-service');
                    },
                    child: Container(
                      width: double.infinity,
                      height: 60.0,
